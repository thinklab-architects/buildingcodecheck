    ...
    return (
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col gap-2">
                ...
                {/* 1. 幾何與分區基本資訊 & 2. 第6條調整用 */}
                {/* Combining these two visually or keeping separate? 
                    The result `art3_6_narrowSite` applies to both. 
                    I'll put the result next to the first one, and maybe leave the second one without a specific result card 
                    OR I can wrap both in one SectionLayout if I change SectionLayout to accept multiple children.
                    But SectionLayout expects children to be the content. I can put two GlassCards in children.
                */}
                <SectionLayout result={results.checks.art3_6_narrowSite} title="檢核結果：面積狹小判定">
                ...
                {/* 3. 第7條 — 地界曲折 */}
                <SectionLayout result={results.checks.art7_tortuousBoundary} title="檢核結果：地界曲折判定">
                ...
                {/* 4. 第8條 — 例外條件檢核 */}
                <SectionLayout result={results.checks.art8_buildability} title="檢核結果：例外建築條件">
                    <GlassCard className="h-full">
                ...
                {/* 5. 第9條 — 舊小基地 */}
                <SectionLayout result={results.checks.art9_legacySmallSite} title="檢核結果：舊小基地例外">
                    <GlassCard className="h-full">
                ...
                {/* 6. 第10條 — 舊丁建、工業區 */}
                <SectionLayout result={results.checks.art10_legacyIndustrialSite} title="檢核結果：舊丁建/工業區例外">
                    <GlassCard className="h-full">
